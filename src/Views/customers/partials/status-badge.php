...
<div class="relative inline-block text-left" x-data="{ open: false }">
    ...
    <div class="hidden absolute left-0 z-10 mt-1 w-36 origin-top-left rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
        <div class="py-1">
            <?php foreach (Customer::STATUSES as $value => $label): ?>
                <button
                    ...
                    hx-swap="innerHTML"
                    class="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 <?= $customer->status === $value ? 'bg-gray-50 font-medium' : '' ?>"
