...
<div class="space-y-6">
    <div>
        ...
        <h1 class="mt-2 text-2xl font-bold text-gray-900">Edit Customer</h1>
    </div>
    ...
    <div class="card p-6 border-red-200 bg-red-50">
        ...
        <p class="mt-1 text-sm text-red-700">Once you delete this customer, there is no going back.</p>
