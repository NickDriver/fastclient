        ...
        <div class="flex-1 lg:pl-64">
            ...
            <main class="py-6 px-4 sm:px-6 lg:px-8">
                ...
                <?php if ($success = flash('success')): ?>
                    <div data-flash class="mb-4 rounded-lg bg-green-50 dark:bg-green-900/30 p-4 text-sm text-green-800 dark:text-green-300 transition-opacity duration-300">
                        <?= e($success) ?>
                    </div>
                <?php endif; ?>

                <?php if ($error = flash('error')): ?>
                    <div data-flash class="mb-4 rounded-lg bg-red-50 dark:bg-red-900/30 p-4 text-sm text-red-800 dark:text-red-300 transition-opacity duration-300">
                        <?= e($error) ?>
                    </div>
                <?php endif; ?>
